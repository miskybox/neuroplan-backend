...
var ExtractService = /** @class */ (function () {
    ...
    ExtractService.prototype.fromPdfBuffer = function (buf) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, pdf_parse_1.default)(buf)];
                    case 1:
                        data = _b.sent();
                        text = (data.text || '').trim();
                        if (!text)
                    ...
                    case 2:
                        _a = _b.sent();
                        throw new common_1.BadRequestException('No se pudo extraer texto (¿PDF escaneado?)');
