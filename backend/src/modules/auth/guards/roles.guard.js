...
var RolesGuard = /** @class */ (function () {
    ...
    RolesGuard.prototype.canActivate = function (context) {
        ...
        var hasRole = requiredRoles.includes(user.rol);
        if (!hasRole) {
            throw new common_1.ForbiddenException("Acceso denegado. Se requiere uno de estos roles: ".concat(requiredRoles.join(', ')));
        }
        return true;
    };
