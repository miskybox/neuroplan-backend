...
var DatabaseService = /** @class */ (function () {
    function DatabaseService(supabaseService) {
    ...
    // Estudiantes
    DatabaseService.prototype.getStudentsByUser = function (userId) {
    ...
    DatabaseService.prototype.createStudent = function (studentData) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, error;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    // Usuarios
    DatabaseService.prototype.getUserById = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, error;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    DatabaseService.prototype.testConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error, error_1;
