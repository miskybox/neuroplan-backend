-- ===========================================
-- NEUROPLAN MIGRATION TO SUPABASE
-- ===========================================
-- Script para migrar desde PostgreSQL local a Supabase
...
-- Tabla de usuarios (unificada con Supabase Auth)
CREATE TABLE IF NOT EXISTS public.users (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    email VARCHAR(255) UNIQUE NOT NULL,
    password VARCHAR(255), -- Solo para usuarios legacy, Supabase Auth maneja esto
...
SELECT 'NeuroPlan Supabase migration completed successfully!' as status;
