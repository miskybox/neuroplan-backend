...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-dark shadow-elegant hover:shadow-glow",
        ...
        accent: "bg-gradient-accent text-accent-foreground hover:shadow-glow transition-spring shadow-elegant",
        success: "bg-gradient-success text-success-foreground hover:shadow-glow transition-spring shadow-elegant",
      },
      size: {
