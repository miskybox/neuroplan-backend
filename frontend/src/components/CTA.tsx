        ...
        <div className="max-w-4xl mx-auto">
          <div className="rounded-3xl bg-gradient-hero p-12 lg:p-16 shadow-glow text-center space-y-8 animate-in fade-in zoom-in duration-1000">
            ...
            <p className="text-lg text-white/90 max-w-2xl mx-auto">
              Transforma tus características neurocognitivas en el motor de tu
              éxito académico con NeuroPlan AI Campus
            </p>
            ...
            <p className="text-sm text-white/80 pt-4">
              Titulación oficial garantizada · Validación curricular LOMLOE
              compliant
            </p>
          </div>
        </div>
